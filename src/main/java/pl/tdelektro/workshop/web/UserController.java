...
public class UserController {
    ...
    @GetMapping("/{userId}")
    ResponseEntity<User> getUser(@PathVariable Long userId) throws UserNotFoundException {
        return new ResponseEntity<>(userService.getUser(userId), HttpStatus.OK);
    }

    //User retrieve his data from database after registration and successful login
    @GetMapping("/email/{userEmail}")
    ResponseEntity<User> getUserData(@PathVariable String userEmail) throws UserNotFoundException {
    ...
    ResponseEntity<HttpStatus> assignUserToCar(@PathVariable Long userId, @PathVariable Long carId) throws UserNotFoundException, CarNotFoundException {
    ...
    ResponseEntity<HttpStatus> deleteUser(@PathVariable Long userId) throws UserNotFoundException {
    ...
    ResponseEntity<User> updateUser(@PathVariable Long userId, @RequestBody User user) throws UserNotFoundException {
